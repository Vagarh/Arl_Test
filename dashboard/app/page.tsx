...
// ⚡ Bolt: Optimize bundle size by lazy loading view components
// Since this app uses state-based routing instead of file-system routing,
// synchronous imports would load all views in the initial bundle.
// Using next/dynamic defers loading until the view is actually rendered.
