...
// ⚡ Bolt Optimization: Dynamic Imports for Code Splitting
// Using next/dynamic instead of static imports defers loading the JavaScript
// for secondary views until they are rendered. This drastically reduces the
// initial bundle size (First Load JS) since the router state is managed locally
// rather than through the Next.js file-system router.
