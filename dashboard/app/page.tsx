...
// ⚡ Bolt: Dynamically load view components to reduce initial JavaScript bundle size.
// Since we use state-based routing instead of file-based routing, this ensures we
// don't load the code for all views upfront.
