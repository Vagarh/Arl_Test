...
// ⚡ Bolt Optimization: Lazily loading view components.
// Since this dashboard uses state-based routing instead of Next.js file-system routing,
// importing these components synchronously would bundle them all into the initial load.
// Using next/dynamic ensures each view is only loaded when activated, reducing the initial JS bundle size.
