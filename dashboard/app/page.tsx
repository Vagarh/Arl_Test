...
// Since we use state-based routing instead of Next.js file-system routing,
// standard imports cause all views to be loaded in the initial bundle.
// Using next/dynamic allows us to split the bundle and only load the active view.
